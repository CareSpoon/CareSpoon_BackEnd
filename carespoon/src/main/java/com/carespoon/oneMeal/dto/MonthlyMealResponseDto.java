...
public class MonthlyMealResponseDto {
    ...
    @QueryProjection
    public MonthlyMealResponseDto(double meal_Kcal, double meal_Carbon, double meal_Fat, double meal_Protein, double meal_na, double meal_cal, double meal_fe,String eatMonth ){
