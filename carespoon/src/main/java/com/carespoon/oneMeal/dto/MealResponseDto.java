...
public class MealResponseDto {
    ...
    @QueryProjection
    public MealResponseDto(double meal_Kcal, double meal_Carbon, double meal_Fat, double meal_Protein, double meal_na, double meal_cal, double meal_fe, String imageUrl, String eatDate, String eatTime, String tag ){
